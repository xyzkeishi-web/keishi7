...
// Note: gi_output_website_schema function is defined in seo-fixes-comprehensive.php to prevent duplication

// Note: gi_output_organization_schema function is defined in seo-fixes-comprehensive.php to prevent duplication
...
// Note: Breadcrumb functions (gi_generate_breadcrumb_data, gi_generate_breadcrumb_json_ld, gi_render_breadcrumb_html) 
// are defined in theme-foundation.php with proper function_exists() checks to prevent conflicts
...
// Note: Image enhancement filter is handled by gi_enhance_image_seo in seo-fixes-comprehensive.php to prevent conflicts
